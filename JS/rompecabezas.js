...
https://demonassit.github.io/4IV7-PSW-Practicas/JS/rompecabezas.js
    //enviar la pos del elemento

    currentPosX = parseInt(elementoSeleccionado.getAttribute("x"));
    currentPosY = parseInt(elementoSeleccionado.getAttribute("y"));
